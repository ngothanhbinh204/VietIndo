...
function create_service_post_type() {
    $labels = array(
        ...
        'archives'              => __('Serivce Archives', 'text_domain'),
        'attributes'            => __('Serivce Attributes', 'text_domain'),
        'parent_item_colon'     => __('Parent Serivce:', 'text_domain'),
        'all_items'             => __('All Serivce', 'text_domain'),
        'add_new_item'          => __('Add New Serivce', 'text_domain'),
        'add_new'               => __('Add New', 'text_domain'),
        'new_item'              => __('New Serivce', 'text_domain'),
        'edit_item'             => __('Edit Serivce', 'text_domain'),
        'update_item'           => __('Update Serivce', 'text_domain'),
        'view_item'             => __('View Serivce', 'text_domain'),
        'view_items'            => __('View Serivce', 'text_domain'),
        'search_items'          => __('Search Serivce', 'text_domain'),
        'not_found'             => __('Not found', 'text_domain'),
        'not_found_in_trash'    => __('Not found in Trash', 'text_domain'),
    );

    $args = array(
        'label'                 => __('Serivce', 'text_domain'),
        'description'           => __('Post Type for Serivce', 'text_domain'),
        'labels'                => $labels,
...
// Register Custom Post Type for Catelogue

function create_catalogue_post_type() {
    $labels = array(
        'name'                  => _x('Catalogue', 'Post Type General Name', 'text_domain'),
        'singular_name'         => _x('Catalogue', 'Post Type Singular Name', 'text_domain'),
        'menu_name'             => __('Catalogue', 'text_domain'),
        'name_admin_bar'        => __('Catalogue', 'text_domain'),
        'archives'              => __('Catalogue Archives', 'text_domain'),
        'attributes'            => __('Catalogue Attributes', 'text_domain'),
        'parent_item_colon'     => __('Parent Catalogue:', 'text_domain'),
        'all_items'             => __('All Catalogue', 'text_domain'),
        'add_new_item'          => __('Add New Catalogue', 'text_domain'),
        'add_new'               => __('Add New', 'text_domain'),
        'new_item'              => __('New Catalogue', 'text_domain'),
        'edit_item'             => __('Edit Catalogue', 'text_domain'),
        'update_item'           => __('Update Catalogue', 'text_domain'),
        'view_item'             => __('View Catalogue', 'text_domain'),
        'view_items'            => __('View Catalogue', 'text_domain'),
        'search_items'          => __('Search Catalogue', 'text_domain'),
        'not_found'             => __('Not found', 'text_domain'),
        'not_found_in_trash'    => __('Not found in Trash', 'text_domain'),
    );
    ...
    $args = array(
        ...
        'description'           => __('Post Type for Catalogue', 'text_domain'),
        'labels'                => $labels,
        'supports'              => array('title', 'editor', 'thumbnail','excerpt'),
        'hierarchical'          => false,
        'public'                => true,
